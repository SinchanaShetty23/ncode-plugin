...
public class AskQuestionAction extends AnAction {
    ...
    public void actionPerformed(@NotNull AnActionEvent e) {
        ...
        if (toolWindow.getContentManager().getContentCount() == 0) {
            AskQuestionToolWindowContent contentPanel = new AskQuestionToolWindowContent();
        ...
        if (content != null && content.getComponent() instanceof AskQuestionToolWindowContent) {
            AskQuestionToolWindowContent contentPanel = (AskQuestionToolWindowContent) content.getComponent();
